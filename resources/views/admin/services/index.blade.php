    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-md-end">
            <a href="{{ route('admin.services.create') }}" class="btn btn-success">
                <span><i class="bi bi-plus-circle"></i> Tambah Layanan</span>
            </a>
        </div>
    </div>
    ...
    @else
        <div class="card border-0 shadow-sm">
            <div class="card-body py-5 text-center">
                <div class="mb-3">
                    <span style="font-size: 3rem;"><i class="bi bi-gear"></i></span>
                </div>
                ...
                <a href="{{ route('admin.services.create') }}" class="btn btn-success">
                    <span><i class="bi bi-plus-circle"></i> Tambah Layanan Pertama</span>
                </a>
            </div>
        </div>
    @endif
